...
### **Power**  
Power is a fundamental engineering principle that determines how much work a motor can perform over time. In our chassis, the JGB37-520 motor was chosen because it delivers sufficient power to overcome friction, inertia, and load resistance while maintaining consistent movement. Power (measured in watts) is directly related to torque (rotational force) and speed (RPM), ensuring the car can accelerate and sustain motion efficiently. The motor’s power is transmitted through the gear system, which amplifies torque to the wheels, allowing the vehicle to move smoothly even under slight resistance. Without adequate power, the motor would struggle to drive the chassis effectively, leading to poor performance or stalling.  
...
Torque is the rotational force produced by the motor, essential for overcoming resistance and initiating movement. The JGB37-520 motor generates enough torque to start the car from rest and maintain motion despite friction and weight. The gear mechanism plays a critical role in torque multiplication—since the motor’s gear is smaller than the axle gear, it increases torque at the cost of some speed (mechanical advantage). This ensures the rear wheels receive enough force to push the chassis forward without excessive strain on the motor. Without proper torque management, the car might struggle on inclines or fail to accelerate efficiently.  
